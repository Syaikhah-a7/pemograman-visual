...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        btnInput.ForeColor = SystemColors.ButtonFace
        btnInput.Location = New Point(368, 258)
        btnInput.Name = "btnInput"
        btnInput.Size = New Size(100, 39)
        btnInput.TabIndex = 0
        btnInput.Text = "Input"
        ...
        ' txtNilai
        ' 
        txtNilai.Location = New Point(346, 203)
        ...
        ' picImage
        ' 
        picImage.Location = New Point(312, 68)
        picImage.Name = "picImage"
        picImage.Size = New Size(223, 129)
